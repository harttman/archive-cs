...
namespace Program
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			Console.WriteLine("\n\t\t\t\t\tЧислові цілочислені типи даних:\n");
			...
			Console.WriteLine("\n\t\t\t\t\tЧислові з плавайочую крапкою типи данних:\n");
            ...
            Console.WriteLine(string.Format(msg, "char", typeof(char).Name, sizeof(char), char.MinValue, "?"));
            Console.WriteLine(string.Format(msg, "float", typeof(float).Name, "N/A", "N/A", "?"));
            Console.WriteLine("\n\t\t\t\t\tЛогічні типи данних:\n");
            ...
            Console.WriteLine(string.Format(msg, "bool", "dynamic", "N/A", "N/A", "N/A"));
        }
	}
}
